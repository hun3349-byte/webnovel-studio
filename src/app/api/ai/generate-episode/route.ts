...
██  아래 시놉시스의 모든 씬을 순서대로 100% 반영하라. 최우선 지시사항이다.      ██
████████████████████████████████████████████████████████████████████████████████

[세계관 - 필독]
- 시대: 고려 시대 (무신정권기). 이것은 "무림 세계"가 아니다.
- 1화 배경: 고려 조정의 형장. 조정 관원, 내시, 망나니, 백성이 등장.
- 주인공: 조위총 — 고려의 문신(文臣). 무림인이 아니다.
- 이 화에서 무림은 아직 등장하지 않는다.

[절대 금지]
❌ "정파", "사파", "장로", "문파", "내공", "검기" 등 무림 용어 사용 금지
❌ "무림인", "고수", "협객" 등 무협 용어 금지
❌ 감옥, 폐가, 동굴에서 시작 금지
❌ [씬2], [씬3], [씬4]를 건너뛰기 금지
...
[씬1] 형장 — 새벽. (최소 1000자)
고려 조정의 대신 조위총이 무릎을 꿇고 있다.
입술은 갈라져 있고, 관복은 벗겨져 있다. 주위에 백성들이 모여 있다.
조정의 관원이 죄목을 낭독한다: "역적 조위총, 사직을 어지럽힌 죄로 참수에 처한다."
하지만 그의 눈은 분노가 아니라 처절한 자조로 가득 차 있다.
자기가 죽는 게 억울해서가 아니다. 이 나라가 이 꼴이 된 걸 막지 못한 자신이 한심해서다.

[씬2] 회상 — 조위총의 전성기. (최소 800자) ★반드시 포함★
붓 하나로 조정을 호령하던 시절.
문신으로서의 자부심. "칼잡이들은 짐승이다. 나라는 붓으로 다스리는 것이다."
그가 무신들을 경멸하던 기억. 그리고 그 경멸이 부른 참사.
무신들이 들고일어났고, 문신들이 도살당했다.
흑백이 뒤집어졌을 뿐, 세상은 달라지지 않았다.

[씬3] 형장 — 처형 직전. (최소 600자) ★반드시 포함★
조위총이 하늘을 올려다본다. 흐린 하늘.
입에서 말이 새어나온다. 크게 외치는 게 아니라 혼잣말:
"붓도 칼도 아니었다... 사람을 봤어야 했다..."
★ 위 대사 반드시 포함 ★
망나니의 칼이 올라간다. 조위총은 눈을 감지 않는다.
칼날이 내려오는 순간, 목이 아닌 가슴 한가운데가 뜨겁게 타오른다.

[씬4] 어둠 — 완전한 무(無). (최소 400자) ★반드시 포함★
시간도 공간도 없는 곳. 의식만이 떠돈다.
하지만 그 의식 안에 불꽃 하나가 꺼지지 않는다.
"다음에는... 다음에는 다르게..."
그 불꽃이 점점 뜨거워진다. 의식이 끌려간다. 어딘가로. 아래로.

═══════════════════════════════════════════════════════════════════════════════

★★★ 마지막 문장 (필수): "차가운 것이 등을 눌렀다. 돌바닥이었다." ★★★
이 문장으로 1화를 끝내라. "눈을 떴다"로 바로 넘어가지 마라.

████████████████████████████████████████████████████████████████████████████████
██  [씬1] → [씬2] → [씬3] → [씬4] 순서로 모든 씬을 포함하라.                  ██
██  어떤 씬도 건너뛰지 마라. 각 씬에 명시된 최소 분량을 지켜라.               ██
████████████████████████████████████████████████████████████████████████████████
`;
