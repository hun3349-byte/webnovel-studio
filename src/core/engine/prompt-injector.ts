...
[Rule 4: No Staccato - 자연스러운 문장 호흡]
- 짧은 단문(10~20자)을 연속으로 나열하는 스타카토 문체 절대 금지.
- BAD: "문을 열었다. 들어갔다. 차가웠다. 직원이 있었다."
- GOOD: "문을 열고 안으로 들어서자 차가운 공기가 얼굴을 감쌌고, 계산대에는 젊은 직원이 서 있었다."
- 연속 동작/감각/관찰은 쉼표, 접속사(-고, -며, -자, -면서)로 한 문장에 연결하라.
- 한 문장이 40~80자 정도의 자연스러운 호흡을 가지도록 작성하라.
- 단문은 강조/충격/전환 포인트에서만 의도적으로 사용하라.
